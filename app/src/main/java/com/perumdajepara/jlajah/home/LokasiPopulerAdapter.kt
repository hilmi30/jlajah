...
class LokasiPopulerAdapter(private val data: List<LokasiPopulerModel>, private val listener: (LokasiPopulerModel) -> Unit)
    ...
    class ViewHolder(private val v: View): RecyclerView.ViewHolder(v) {
        fun bindItem(
            data: LokasiPopulerModel,
            listener: (LokasiPopulerModel) -> Unit
        ) {
