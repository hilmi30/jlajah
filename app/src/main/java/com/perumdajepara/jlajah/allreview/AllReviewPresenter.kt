...
class AllReviewPresenter: BasePresenter<AllReviewView> {

    private var mView: AllReviewView? = null
    private val services = RetrofitBuilder.getInstance(BuildConfig.BASE_URL_API).create(ApiRepository::class.java)
    private var disposable: Disposable? = null

    override fun onAttach(view: AllReviewView) {
        mView = view
    }
    ...
    fun getAllReview(context: Context, idLocation: Int, page: Int, perPage: Int) {
        mView?.showLoading()
        disposable = services.getAllReview(idLocation, page, perPage)
